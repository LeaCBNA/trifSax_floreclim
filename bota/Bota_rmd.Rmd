...
#specpool(t_dat_prabs_21, smallsample = TRUE) # a activer quand tout saisi
...
``` {r NMDS sp ab 2018 pac, echo = FALSE, results = "hide", fig.show = "hide"}
...
``` {r NMDS sp ab 2011, echo = FALSE, results = "hide", fig.show = "hide"}
...
``` {r NMDS sp ab 2011 pac, echo = FALSE, results = "hide", fig.show = "hide"}
...
``` {r NMDS plot ab 2011, echo = FALSE, results = "hide"}
## 2011
...
``` {r NMDS sp ab 2021, echo = FALSE, results = "hide", fig.show = "hide"}
...
``` {r NMDS sp ab 2021 pac, echo = FALSE, results = "hide", fig.show = "hide"}
...
```{r NMDS plot ab 2021, echo = FALSE, results="hide"}
...
```{r NMDS multiDyn, echo = TRUE, results = "show", fig.show = "hide"}
