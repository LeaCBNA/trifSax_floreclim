...
Certaines placettes ont une faible similarité (Villaroger haut, Vallouise Glacier blanc) indiquant un grand changement de la composition entre 2018 et 2021. La majorité des indices tourne entre 0.5 et 0.75. C'est sur Bérarde Clapier que la similarité 2018/2021 est la plus importante. 
...
De nombreuses espèces suplémentaires en 21 mais on est sur une placette très grande donc il y a probabalement de la sous-observation en 18.
...
```
Sans surprise on retrouve deux pools constitués respectivement des placettes de Maurienne et de Villaroger qui se rapprochent floristiquement. Ces deux pools sont relativement proches entre eux, et se rapprochent également des placettes de Vallouise, qui ne forment pas un pool distinct mais se répartissent autour des deux précédents. __A noter les sous-placettes qu'il faudrait regrouper, celles de la placette Vallouise_moraine_haut se retrouvent proches mais celles d'Eychauda torrent sont assez éloignées.__  

Les placettes de La Bérarde sont bien distinctes, entre elles et avec toutes les placettes de Maurienne, Vallouise et Villaroger. On a une ségrégation horizontale entre les domaines versant/moraine et fluvio-glaciaire.  
...
En 2021 on a un pattern un peu différent, avec cette fois la "fausse" placette du clapier qui se rapproche plus de celles de Vallouise, ce qui est logique puisque elle ressemble à une pelouse (terrasse alluviale très très ancienne et très végétalisée). 
...
On retrouve un peu cette tendance en regardant les indices de Jaccard (_Cf_ 3.2) mais ils ont été calculés en P/A donc c'est différent.   
